...
TIMESTAMP:str = datetime.now().strftime("%m_%d__%Y_%H_%M_%S")
...
class DataTransformationConfig:
        ...
        transformed_train_file_path:str = os.path.join(data_transformation_dir, DATA_TRANSFORMATION_TRANSFORMED_OBJECT_DIR,
                                                       TRAIN_FILE_NAME.replace("csv","npy"))
        transformed_test_file_path:str = os.path.join(data_transformation_dir,DATA_TRANSFORMATION_TRANSFORMED_OBJECT_DIR,
